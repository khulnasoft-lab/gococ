	...
	reg.AddRoute(Route{
		...
		Does: Tasks{
			...
			Cmd{
				...
				// Tell Gococ what function to execute when we get to this
				// step.
				//
				...
				// value here, Gococ can get that information from another
...
func TestGococForCoCo(t *testing.T) {
	registry, router, cxt := Gococ()
