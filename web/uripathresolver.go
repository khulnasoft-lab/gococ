...
func (r *URIPathResolver) Resolve(pathName string, cxt gococ.Context) (string, error) {
	...
	return pathName, &gococ.RouteError{"Could not resolve route " + pathName}
}

func (r *URIPathResolver) subtreeMatch(c gococ.Context, pathName, pattern string) bool {
