/*
	The Gococ `fmt` package provides utility wrappers for formatting text.
...
func Template(c gococ.Context, p *gococ.Params) (interface{}, gococ.Interrupt) {
	format := gococ.GetString("template", "", p)
	withCxt := gococ.GetBool("template.Context", false, p)
...
func Println(c gococ.Context, p *gococ.Params) (interface{}, gococ.Interrupt) {
	msg := gococ.GetString("content", "", p)
	fmt.Println(msg)
	return msg, nil
}
...
func Printf(c gococ.Context, params *gococ.Params) (interface{}, gococ.Interrupt) {
...
//   - "0"... (string): String representation of an integer ascending from 0.
//     These are treated as positional.
func Sprintf(c gococ.Context, params *gococ.Params) (interface{}, gococ.Interrupt) {
	msg := params.Get("format", "").(string)
