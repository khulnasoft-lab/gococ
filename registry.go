...
// Route declares a new Gococ route.
//
...
// Cmd associates a gococ.Command to a Route.
//
...
//
// Fn specifies which gococ.Command should be executed during this step.
//
// Using contains a list of Parameters that Gococ can pass into the Command
// at execution time.
type Cmd struct {
	Name  string
	Fn    Command
