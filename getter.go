...
Many of these functions are forward-looking to Gococ 2.x, where Context and
...
//
// In Gococ 1.x, Context's Get() function returns a ContextValue instead of
// an interface. For that reason, you may need to wrap Cxt in GettableCxt
// to make it a true Getter.
//
// In Gococ 1.x, KeyValueDatasource uses Value() instead of Get()/Has(). For
...
//
// In future versions of Gococ, core Datasources will directly implement Getter.
