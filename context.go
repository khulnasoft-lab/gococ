...
// Copyright 2013, 1014 Khulnasoft-lab

import (
	"io"
	"log"

	cio "github.com/Khulnasoft-lab/gococ/io"
)
...
// A word of warning.
//
// The Gococ system was designed around the theory that commands should
...
// via a gococ.Param. And a command generally should return a value that
...
type Context interface {
	...
	// DEPRECATED. This will be removed in Gococ 2.0. Use
	// Put instead.
...
// NewContext creates a new empty gococ.ExecutionContext and calls its Init() method.
